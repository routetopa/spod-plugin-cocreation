...
copySettings()
{
    ...
    cp -R ./es_client/locales/* /home/ethersheet/ethersheet/EtherSheet/node_modules/es_client/locales
    cp -R ./es_client/config.js /home/ethersheet/ethersheet/EtherSheet/node_modules/es_client
