...
class COCREATION_CTRL_Ajax extends OW_ActionController
{
    ...
    function getNoteHTMLByPadIDApiUrl() {
        ...
        try {
            ...
            $apiurl =$_SERVER['REQUEST_SCHEME'] . "://" . $_SERVER['HTTP_HOST'] . "/ethersheet" . "/api/1/getHTML?apikey=e20a517df87a59751b0f01d708e2cb6496cf6a59717ccfde763360f68a7bfcec&padID=" . explode("/", $clean['noteUrl'])[4];
            $ch = curl_init();
